//! Vendored from gpui-component (rev 0315556) `crates/ui/src/resizable/`.
//!
...
// Kept verbatim from upstream, so don't lint it as if it were our own code: the
// app only uses part of the API, and the rest should stay in place for the next
// re-sync.
#![allow(
    dead_code,
